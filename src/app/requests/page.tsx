...
export default function MyRequestsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'assigned': return <Badge className="bg-yellow-100 text-yellow-700 hover:bg-yellow-100 border-none">تم الإسناد</Badge>;
    ...
    <Shell role="hospital">
      <div className="space-y-6" dir="rtl">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold font-headline text-right">طلبات الصيانة الخاصة بي</h1>
            <p className="text-muted-foreground text-right">تابع تقدم طلبات الصيانة والعروض المقدمة من المهندسين.</p>
          </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div className="flex gap-4 text-right w-full sm:w-auto">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-3 mt-1 text-sm text-muted-foreground justify-end sm:justify-start">
